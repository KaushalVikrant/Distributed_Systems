...
regroup-allgather
allreduce
regroup-allgatherSeq (For running program with multi-threading) You can use this command with one Mapper for sequential simulation
allreduceSeq (For running program with multi-threading) You can use this command with one Mapper for sequential simulation
}
